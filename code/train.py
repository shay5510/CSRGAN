...
#from places_dataset_cv2 import Places_dataset
...
from new_generators.Generator_break_63_plus_1 import GeneratorBroken63
from new_generators.Generator_feature_extractor import GeneratorFeatures
from new_generators.Generator_RRDB import GeneratorRRDB
...
def save_results_img_grid(path, gen_result, target, fname='results_grid.png', tot_images=10, nrows=2):
    #unnormalize=transforms.Normalize((-middle_mean/middle_std).tolist(),(1.0/middle_std).tolist())
    #result=unnormalize(result)
    #target=unnormalize(target)
    #gen_result=gen_result*0.5 +0.5
...
places_dataset_val="../../../data/val_256/val_256"
spongebob_dataset="../../../data/spongebob_dataset_480/spongebob_dataset_480"
ten_dogs_dataset="../../../data/dogs_datasets/10_dog_dataset"
thirty_dogs_dataset_train="../../../data/dogs_datasets/6k_images_dogs/train"
thirty_dogs_dataset_val="../../../data/dogs_datasets/6k_images_dogs/val"

type_of_dataset="10_dogs"
spongebob_fname="frame_"
ten_dogs_fname=""

train_dataset = Places_dataset(data_path=ten_dogs_dataset,indexrange=(1,1800),fname=ten_dogs_fname,type_of_dataset=type_of_dataset, transforms=transforms.Compose([transforms.Normalize(mean=middle_mean,std=middle_std)]))


train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=16, shuffle=True,num_workers=4)

val_dataset = Places_dataset(data_path=ten_dogs_dataset,indexrange=(1800,1900),fname=ten_dogs_fname,type_of_dataset=type_of_dataset,full_data=True, transforms=transforms.Compose([transforms.Normalize(mean=middle_mean,std=middle_std)]))
